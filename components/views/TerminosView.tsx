...
const SECTIONS = [
  { title: "1. Aceptación de los Términos", content: "Al acceder y utilizar el sitio web de Electro Thina, usted acepta estar sujeto a estos Términos y Condiciones de uso. Si no está de acuerdo con alguno de estos términos, le recomendamos no utilizar nuestros servicios." },
  ...
  { title: "8. Propiedad Intelectual", content: "Todos los contenidos de este sitio (textos, imágenes, logotipos, diseño) son propiedad de Electro Thina o de sus respectivos titulares y están protegidos por la legislación peruana e internacional." },
  { title: "9. Limitación de Responsabilidad", content: "Electro Thina no se responsabiliza por daños indirectos, pérdidas de datos o interrupciones del servicio derivados del uso de este sitio." },
  { title: "10. Legislación Aplicable", content: "Estos Términos y Condiciones se rigen por las leyes de la República del Perú. Cualquier controversia será sometida a los tribunales competentes de la ciudad de Lima." },
]
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="mx-auto max-w-4xl px-4 py-14">
        ...
        <div className="mb-10">
          ...
          <h1 className="mb-3 text-3xl font-extrabold tracking-tight text-[#121A47] lg:text-4xl">Términos y Condiciones</h1>
          <p className="text-sm text-slate-500">Última actualización: enero de 2026 · Electro Thina S.A.C. — Lima, Perú</p>
        </div>
        ...
        <div className="mb-8 rounded-2xl border border-primary/10 bg-primary/[0.03] p-6">
          <p className="text-sm leading-relaxed text-slate-600">
            ...
            <strong className="text-[#121A47]">Electro Thina S.A.C.</strong>, empresa fabricante y distribuidora de materiales eléctricos para alta y media tensión.
          </p>
        </div>
        ...
        <div className="mt-10 rounded-2xl bg-[#121A47] p-7 text-center">
          ...
          <Link href="/contacto" className="inline-flex items-center gap-2 rounded-xl bg-red-600 px-6 py-3 text-sm font-bold text-white transition-all hover:bg-red-700">
            Contactar
          </Link>
        </div>
      </div>

...
export function CtaBand() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute -right-32 bottom-0 h-64 w-64 rounded-full bg-slate-600/6 blur-3xl" />

      <div className="relative mx-auto max-w-7xl px-4 py-20">
        <div className="flex flex-col items-center gap-10 lg:flex-row lg:items-center lg:justify-between">
          <motion.div variants={fadeLeft} className="max-w-xl text-center lg:text-left">
            <p className="mb-2 text-[11px] font-bold uppercase tracking-[0.3em] text-slate-400">
              {c.badge}
            </p>
            <h2 className="mb-4 text-3xl font-extrabold leading-tight tracking-tight text-white lg:text-4xl">
              {c.title}
              <br />
              <span className="bg-gradient-to-r from-slate-400 to-orange-400 bg-clip-text text-transparent">
                {c.titleHighlight}
              </span>
            </h2>

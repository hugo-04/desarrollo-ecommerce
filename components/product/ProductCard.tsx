...
export function ProductCard({ product, showBadge = false }: ProductCardProps) {
  return (
    <Link
      ...
      className="group block cursor-pointer overflow-hidden rounded-[24px] border border-slate-200/50 bg-white transition-all duration-700 hover:-translate-y-2 hover:shadow-[0_20px_40px_rgba(28,40,112,0.12)] hover:border-slate-500/40"
    >
      <div className="relative aspect-[4/3] overflow-hidden bg-gradient-to-b from-slate-50 to-slate-100 p-8">
        ...
        {showBadge && (
          <span className="absolute left-4 top-4 z-20 flex items-center gap-1.5 rounded-full bg-gradient-to-r from-slate-600 to-slate-500 px-3 py-1.5 text-[10px] font-black uppercase tracking-widest text-white shadow-lg shadow-slate-600/30 ring-1 ring-white/20">
        ...
        {product.fichaTecnica && (
          <button
            ...
            className="absolute bottom-4 right-4 z-20 flex items-center gap-1.5 rounded-xl bg-white/95 px-3 py-2 text-[10px] font-bold text-[#64748b] shadow-lg shadow-black/5 ring-1 ring-slate-200/50 backdrop-blur-md transition-all duration-300 hover:bg-[#64748b] hover:text-white hover:shadow-[#64748b]/30"
      ...
      <div className="flex flex-col p-6">
        <div className="mb-3 flex items-center gap-2">
          <span className="rounded-md bg-[#334155] px-2.5 py-1 text-[9px] font-black uppercase tracking-wider text-white shadow-sm">{product.brand}</span>
        </div>
        <h3 className="mb-2 line-clamp-2 min-h-[44px] text-[15px] font-extrabold leading-snug text-[#1e293b] transition-colors group-hover:text-[#64748b]">{product.name}</h3>
        ...
        <div className="mt-auto">
          <span className="flex w-full items-center justify-center gap-2 rounded-xl bg-slate-100 py-3 text-xs font-bold text-[#334155] transition-all duration-300 group-hover:bg-gradient-to-r group-hover:from-[#334155] group-hover:to-[#1e293b] group-hover:text-white group-hover:shadow-lg group-hover:shadow-[#334155]/25">

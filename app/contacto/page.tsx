      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#121A47] via-primary to-[#0B1035] py-20">
        ...
        <div className="relative mx-auto max-w-7xl px-4 text-center">
          ...
          <p className="mx-auto max-w-2xl text-base text-slate-400 sm:text-lg">
            Nuestro equipo de ingenieros esta listo para ayudarte a seleccionar los materiales adecuados para tu proyecto.
          </p>
        </div>
      </section>
              ...
              <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm lg:p-8">
                ...
                {submitted ? (
                  <div className="rounded-xl bg-green-50 p-8 text-center">
                    ...
                    <p className="text-sm text-green-700">Nos pondremos en contacto contigo en un plazo de 24 horas habiles.</p>
                  </div>
                ) : (
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="grid gap-4 sm:grid-cols-2">
                      ...
                      <div>
                        <label className="mb-1.5 block text-xs font-semibold text-slate-700">Telefono</label>
      ...
      <section className="bg-slate-100 py-16">
        <div className="mx-auto max-w-7xl px-4">
          <div className="mb-6 text-center">
            <h2 className="text-xl font-bold text-slate-900">Encuentra nuestra ubicacion</h2>
          </div>
          <div className="overflow-hidden rounded-2xl border border-slate-200 bg-slate-200 shadow-sm">
            <div className="flex h-80 items-center justify-center bg-gradient-to-br from-slate-200 to-slate-300">
              <div className="text-center">
                ...
                <p className="text-sm font-semibold text-slate-700">Av. Industrial 1234, Lima, Peru</p>
                <p className="text-xs text-slate-500">Zona Industrial</p>
              </div>
            </div>
          </div>
        </div>

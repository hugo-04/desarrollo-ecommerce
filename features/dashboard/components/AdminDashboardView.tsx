...
export function AdminDashboardView({ recentProducts, totalProducts, categories, brands }: AdminDashboardViewProps) {
  ...
  const stats = [
    ...
    {
      label: "Marcas",      value: brands.length,      desc: "lorem ipsum",
    ...
    <div className="space-y-8 pb-12">
      ...
      <div className="flex animate-in slide-in-from-top-4 fade-in flex-col items-start justify-between gap-4 duration-500 sm:flex-row sm:items-center">
        <div>
          ...
          <p className="mt-1 text-sm font-medium text-slate-500">Monitor centralizado del catálogo de Lorem Ipsum</p>
        </div>
        <Link href="/productos/nuevo"
          className="group relative inline-flex items-center gap-2 overflow-hidden rounded-xl bg-gradient-to-r from-[#334155] to-[#0ea5e9] px-6 py-3 text-sm font-bold text-white shadow-xl shadow-[#334155]/20 transition-all duration-300 hover:scale-[1.02] hover:shadow-cyan-500/30">
          ...
          <div className="divide-y divide-slate-100/50">
            {recentProducts.length === 0 ? (
              <div className="flex flex-col items-center px-6 py-16 text-center">
                ...
                <Link href="/productos/nuevo" className="mt-3 inline-flex items-center gap-1 text-sm font-bold text-[#334155] transition-colors hover:text-[#0ea5e9]">
        ...
        <div className="flex flex-col gap-6 lg:col-span-2">
          ...
          <div className="rounded-3xl border border-white/60 bg-white/50 p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] backdrop-blur-xl">
            ...
            <div className="flex flex-col gap-3">
              <Link href="/productos/nuevo" className="group flex items-center gap-3 rounded-2xl bg-gradient-to-tr from-[#334155] to-blue-600 p-4 text-sm font-bold text-white shadow-xl shadow-blue-900/10 transition-all duration-300 hover:-translate-y-0.5">
          ...
          <div className="rounded-3xl border border-white/60 bg-gradient-to-br from-slate-900 to-[#334155] p-6 text-white shadow-xl">
